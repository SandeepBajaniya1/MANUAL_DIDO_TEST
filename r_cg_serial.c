...
void R_SAU1_Create(int baudRate)
{
    ...
    NOP();
    NOP();
    // if (/*(0 != SW_IN_11_1PH_3PH) || */(0 == SW_IN_12_9600_BAUD))
    if((0 == SW_IN_12_9600_BAUD) && (baudRate == 19200))
    {
            SPS1 = _0002_SAU_CK00_FCLK_2 | _0020_SAU_CK01_FCLK_2;       //19200 Baud
    }
    else
    {
            SPS1 = _0003_SAU_CK00_FCLK_3 | _0030_SAU_CK01_FCLK_3;       //9600 Baud
    }
...
void R_UART3_Create(void)
{
    ...
    SCR12 = _8000_SAU_TRANSMISSION | _0000_SAU_INTSRE_MASK | _0000_SAU_PARITY_NONE | _0080_SAU_LSB | _0010_SAU_STOP_1 |
            _0007_SAU_LENGTH_8;
    SDR12 = _9A00_UART3_TRANSMIT_DIVISOR;

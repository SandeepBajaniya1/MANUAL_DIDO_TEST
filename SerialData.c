...
__interrupt static void r_uart0_interrupt_receive(void)
{
    ...
    stComm[0].byRdBuf[stComm[0].byWrPtr++] = rx_data;
    if (stComm[0].byWrPtr >= 248)
        stComm[0].byWrPtr = 248;
    stComm[0].wRcvTimeOut = 0;
}
...
{
    if (stComm[0].bySndPtr < stComm[0].bySndLen)
    {
        TXD0 = stComm[0].byWrBuf[stComm[0].bySndPtr];
        stComm[0].bySndPtr++;
    }
    else
    {
...
__interrupt static void r_uart1_interrupt_receive(void)
{
    ...
    stComm[1].byRdBuf[stComm[1].byWrPtr++] = rx_data;
    if (stComm[1].byWrPtr >= 248)
        stComm[1].byWrPtr = 248;
    stComm[1].wRcvTimeOut = 0;
}
//
///***********************************************************************************************************************
...
{
    if (stComm[1].bySndPtr < stComm[1].bySndLen)
    {
        TXD1 = stComm[1].byWrBuf[stComm[1].bySndPtr];
        stComm[1].bySndPtr++;
    }
    else
    {
...
__interrupt static void r_uart2_interrupt_receive(void)
{
    ...
    stComm[2].byRdBuf[stComm[2].byWrPtr++] = rx_data;
    if (stComm[2].byWrPtr >= 248)
        stComm[2].byWrPtr = 248;
    stComm[2].wRcvTimeOut = 0;
}
...
{
    if (stComm[2].bySndPtr < stComm[2].bySndLen)
    {
        TXD2 = stComm[2].byWrBuf[stComm[2].bySndPtr];
        stComm[2].bySndPtr++;
    }
    else
    {
...
__interrupt static void r_uart3_interrupt_receive(void)
{
    ...
    stComm[3].byRdBuf[stComm[3].byWrPtr++] = rx_data;
    if (stComm[3].byWrPtr >= 248)
        stComm[3].byWrPtr = 248;
    stComm[3].wRcvTimeOut = 0;
}
...
{
    if (stComm[3].bySndPtr < stComm[3].bySndLen)
    {
        TXD3 = stComm[3].byWrBuf[stComm[3].bySndPtr];
        stComm[3].bySndPtr++;
    }
    else
    {
